...
###
 # @Author: your name
 # @Date: 2021-07-13 22:02:57
 # @LastEditTime: 2021-07-13 22:03:17
 # @LastEditors: your name
 # @Description: In User Settings Edit
 # @FilePath: \adc\sd_fusing\sd_fusing.sh
### 
...
echo "BL1 fusing"
./mkbl1 ../x210.bin SD-bl1-8k.bin 8192
...
#<u-boot fusing>
echo "u-boot fusing"
dd iflag=dsync oflag=dsync if=../x210.bin of=$1 seek=$uboot_position
